const Menu = (() => {
  ...
  const CATALOG = [
    ...
    { id: "beef-samosa", name: "Beef Samosa (2 pcs)", category: "starters", price: 1500, description: "Flaky pastry parcels packed with spiced minced beef, onion and curry leaves.", image: "https://upload.wikimedia.org/wikipedia/commons/thumb/6/68/Beef_Samosas_%287558541924%29.jpg/960px-Beef_Samosas_%287558541924%29.jpg" },
    { id: "moin-moin", name: "Moin Moin", category: "starters", price: 800, description: "Savory steamed bean pudding with pepper, onions and a hint of smoked fish.", image: "https://upload.wikimedia.org/wikipedia/commons/thumb/2/26/Moin-Moin-good.jpg/960px-Moin-Moin-good.jpg" },
    { id: "catfish-pepper-soup", name: "Catfish Pepper Soup", category: "starters", price: 3500, description: "Warm, spicy broth with tender catfish chunks and aromatic African spices.", image: "https://upload.wikimedia.org/wikipedia/commons/thumb/7/78/Cat_fish_pepper_soup_with_5Alive_drink.jpg/960px-Cat_fish_pepper_soup_with_5Alive_drink.jpg" },
    ...
    { id: "egusi-pounded-yam", name: "Egusi & Pounded Yam", category: "mains", price: 3600, description: "Rich melon-seed soup with assorted meat over smooth, stretchy pounded yam.", image: "https://upload.wikimedia.org/wikipedia/commons/thumb/3/3a/Egusi_soup_with_pounded_yam_and_assorted_meats.jpg/960px-Egusi_soup_with_pounded_yam_and_assorted_meats.jpg" },
    { id: "amala-ewedu", name: "Amala, Ewedu & Gbegiri", category: "mains", price: 2800, description: "Smooth yam flour amala with slimy ewedu and creamy bean gbegiri.", image: "https://upload.wikimedia.org/wikipedia/commons/thumb/1/10/Amala_and_Abula.jpg/960px-Amala_and_Abula.jpg" },
    ...
    { id: "chin-chin", name: "Chin Chin (100g)", category: "desserts", price: 500, description: "Crunchy, nutmeg-scented fried dough bites — perfect for studying.", image: "https://upload.wikimedia.org/wikipedia/commons/thumb/0/01/A_fried_chin_chin.jpg/960px-A_fried_chin_chin.jpg" },
    { id: "boli-groundnut", name: "Boli & Groundnut", category: "desserts", price: 1000, description: "Slow-roasted plantain with roasted groundnuts and a sprinkle of pepper.", image: "https://upload.wikimedia.org/wikipedia/commons/a/a4/Boli_and_Groundnut.png" },
